...
module Provisioning
  ...
  def self.connect_to_machine(machine_spec, config = Cheffish.profiled_config, input_machine_options ={})
    ...
    if driver
      ...
      machine_options["ip_address"] = machine_spec.node["automatic"]["ipaddress"] unless machine_spec.node["automatic"]["ipaddress"].nil?
